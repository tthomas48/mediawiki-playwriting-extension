<?php
 ...
 $wgExtensionFunctions[] = "wfCharacterName";
 
 function wfCharacterName() {
     global $wgParser;
     ...
     $wgParser->setHook( "c", "renderCharacterName" );
 }
 
 # The callback function for converting the input text to HTML output
 function renderCharacterName( $input, $argv ) {
     # $argv is an array containing any arguments passed to the extension like <example argument="foo" bar>..
     $output = "<div class=\"character\">$input</div>";
     return $output;
 }
 ?>
